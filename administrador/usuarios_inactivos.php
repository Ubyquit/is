...
<head>
    ...
    <title>SIS - Usuarios inactivos</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Lista de usarios inactivos</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                /*Realizar una unión entre la tabla usuarios y la tabla roles y realizar saltos entre campos de ambas tablas para  
                                    ...
                                    $consulta = "SELECT * FROM usuario WHERE estatusUsr = 3";
                                    $resultado = mysqli_query($mysqli, $consulta);
                                    while($fila = mysqli_fetch_array($resultado)){
                                    ?>
                                    <tr>
                                        <!--Imagen predeterminada para usuarios, icono avatar https://robohash.org/-->
                                        <td><img class="rounded-circle mr-2" width="30" height="30" src="https://robohash.org/<?php echo $fila["correoUsr"]; ?>?set=set4"><?php echo $fila["nomUsr"]; ?></td>
