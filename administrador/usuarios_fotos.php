                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                /*Realizar una unión entre la tabla usuarios y la tabla roles y realizar saltos entre campos de ambas tablas para  
                                    ...
                                    $consulta = "SELECT DISTINCT id_usr,nomUsr,apPaternoUsr, correoUsr, estatusUsr FROM usuario INNER JOIN imagenes ON imagenes.usuario_id_usuario = usuario.id_usr";
                                    ...
                                    <tr>
                                        ...
                                        <!--Editar usuario-->
                                        <td><a href="perfil_usuario.php?id=<?php echo $fila["id_usr"]?>" class="btn btn-default btn-rounded"><i class="fa fa-eye" style="color:green" aria-hidden="true"></i></td> 
                                    </tr>
                                    <?php }  ?>
                                </tbody>
                                <tfoot>
