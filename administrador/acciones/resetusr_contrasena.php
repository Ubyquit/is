<?php 
    ...
    $consulta = "UPDATE usuario SET passwordUsr = '$newPassword' WHERE id_usr = '$id'";
    $resultado = mysqli_query($mysqli, $consulta);

    $consulta2 = "SELECT * FROM usuario WHERE id_usr = '$id'";
    $resultado2 = mysqli_query($mysqli, $consulta2);
    $fila = mysqli_fetch_array($resultado2);

    $user = $fila['nomUsr'];
    $email = $fila['correoUsr'];
...
<p style="color: #000000;margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">Se ha restablecido tu contraseña, es importante que la cambies a la brevedad posible.<br>
<br>
Lo único que tienes que hacer es presionar el botón azul&nbsp;e ingresar los siguientes datos de acceso e ir al apartado de tu perfil.<br>
<br>
<strong>Usuario :&nbsp;'.$email.'<br>
Contraseña: '.$newPassword.'</strong><br>
<br>
