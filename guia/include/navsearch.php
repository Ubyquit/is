                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                ...
                                /* muestra la información del usuario */
                                    ...
                                    echo strtoupper($user_session)
                                ?>
                                </span><img class="border rounded-circle img-profile" src="<?php echo "acciones/" . $fila["fotoPrincipal"] ?>"></a>
                                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                                        <!--Logout-->
                                        <a class="dropdown-item" href="../guia/perfil.php"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>Perfil</a>
