                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="guia_insert.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select id="entrenamientoUsr" name="entrenamientoUsr" class="custom-select" required="required">
                                            <option value="1.2">Ligero moderado 1 - 3 días</option>
                                            <option value="1.4">Moderado fuerte 3 - 6 días</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <button onclick="window.location.href='../index.php'" type="button" class="btn btn-outline-primary">Cancelar</button>
                                </div>
                            </form>
