...
session_start();
   ...
   $resultado2 = mysqli_query($mysqli, $consulta2);
    ...
    $consulta = "INSERT INTO IMC (usuario_id_usuario, pesoUsr, alturaUsr,imcUsr,Entrenamiento,mes_mes)
    VALUES ('$varsesion', '$pesoUsr', '$alturaUsr', '$imcUsr','$entrenamientoUsr', now())";
